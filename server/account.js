...
Accounts.onCreateUser((options, user) => {
    ...
    user.defaultModule = options.defaultModule || "";
    user.url = options.url || "";
    ...
    if (user.username === "super") {
        ...
        user.profile.maxUserLogin = 1000;
        user.profile.workDayMorning = [0, 1, 2, 3, 4, 5, 6];
        user.profile.workDayAfternoon = [0, 1, 2, 3, 4, 5, 6];
        user.profile.workTimeMorningStart = "00:00";
        user.profile.workTimeMorningEnd = "12:00";
        user.profile.workTimeAfternoonStart = "12:00";
        user.profile.workTimeAfternoonEnd = "23:59";
        user.module = ["Loan", "Saving"];
        user.defaultModule = "Loan";
    ...
    /*admin*/
        ...
        user.profile.isSideBarImage = true;
        user.profile.userLogin = 0;
        user.profile.maxUserLogin = options.maxUserLogin || 1000;
