          ...
          <v-row type="flex" class="row-bg" justify="center">
            <v-col cols="12">
              <v-card
                  ...
                  max-width="100%"
              >
                <v-card-title>{{ $t('profitLostTitle') }}
                  <v-spacer></v-spacer>
           ...
           style="align-items: center; margin-top: 0px !important;margin-bottom: 5px !important;border-top:1px solid black !important;margin-left: 25% !important;margin-right: 25% !important;">
              ...
              <center v-if="companyDoc.isHasBanner">
                ...
                <v-col cols="12" md="12" sm="12" style="text-align: center !important;padding: 0px !important;">
                        <span
                            style="font-family: 'Khmer OS Muol'; font-size: 15px;">{{ $t('profitLostTitle') }}</span><br>
                </v-col>
...
export default {
      ...
      if (val) {
        this.$nextTick(() => {
          ...
          $(".rowClick").dblclick(function (e, t) {
            ...
            queryParams.dateRang = vm.params.dateRang;
            ...
            Meteor.call("acc_findChartAccountById", e.currentTarget.id, Constants.secret, (err, result) => {
              ...
              vm.$router.push({name: 'transactionDetailReport', params: queryParams})
            })
  ...
  methods: {
    ...
    exportToExcel() {
      ...
      workbook.SheetNames.push("ProfitLost");
      workbook.Sheets["ProfitLost"] = worksheet;

      GlobalFn.exportExcelFile(workbook, "ProfitLost " + moment().format("YYYYMMDD") + ".xlsx");
    },
    FormatNumber(val) {
    ...
    handleRun() {
      ...
      if (this.$refs.formReport.validate()) {
        ...
        Meteor.call('acc_fetchProfitLostReport', this.params, Constants.secret, vm.$i18n.locale, (err, result) => {
          if (result) {
