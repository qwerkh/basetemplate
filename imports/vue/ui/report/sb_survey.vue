              ...
              >
                ...
                <v-card-text>
                  <v-row>
                    ...
                    <v-col cols="12" md="4" sm="4" xs="4">
                      <v-autocomplete v-model="params.type"
                                      :items="agreeConsultantOptions"
                                      outlined
                                      dense
                                      item-text="label"
                                      item-value="value"
      ...
      alt="">
              ...
              <center v-if="companyDoc.isHasBanner">
                ...
                <v-col cols="12" md="12" sm="12" style="text-align: center !important;padding: 0px !important;">
                        <span
                            style="font-family: 'Khmer OS Muol'; font-size: 15px;">{{ $t('surveyTitle') }}</span><br>
                </v-col>
                ...
                <thead style="margin-top: 5px">
                    <tr>
                       ...
                       <th>បរិយាយបន្ថែម</th>
                       <th>ឈ្មោះហ្វេសបុក</th>
                       <th>ចំនូនសមាជិកគ្រួសារដែលមានចំណូលសរុប</th>
                       <th>ឈ្មោះស្ថាប័នដែលកំពុងជំពាក់</th>
                       <th>ចំនួនទឹកប្រាក់ខ្ចីដំបូង</th>
                       <th>រយៈពេលខ្ចី</th>
                       <th>ចំនួនទឹកប្រាក់នៅសល់</th>
                       <th>រយៈពេលនៅសល់</th>
                       <th>ប្រភេទទ្រព្យធានា</th>
                       <th>ធ្លាប់មានការយឺតយ៉ាងសងត្រលប់ឬទេ</th>
                       <th>មូលហេតុសងយឺត</th>
                       <th>ធ្លាប់ដាក់ពាក្យស្នើកម្ចីស្ថាប័នណាខ្លះរយះពេលមួយខែកន្លងមកនេះ</th>
                       <th>ធ្លាប់មានប្រវត្តខូចបំណុល/Write Off ឬទេ?</th>
                       <th>តើបងពេញចិត្តស្ថាប័នដែលបងកំពុងប្រើប្រាស់កម្ចីដែរឬទេ?</th>
                       <th>តើបងមានបំណងចង់បានកម្ចីបន្ថែមដែរឬទេ ឬចង់ប្តូរទៅខ្ចីស្ថាប័នផ្សេងឬទេបើគេអោយបងខ្ចីច្រើនជាងនេះ?</th>
                       <th>ភ្ញៀវចាប់អារម្មណ៍សេវាកម្មមួយណា</th>
                       <th>មូលហេតុ</th>
                       <th>ភ្ញៀវយល់ព្រមអោយខាងក្រុមហ៊ុនប្រឹក្សា</th>
...
export default {
  ...
  data() {
    return {
      ...
      loading: false,
      branchOptionList: [],
      agreeConsultantOptions: [
        {label: "យល់ព្រមប្រឹក្សាកម្ចី", value: "true"},
        {label: "មិនយល់ព្រមប្រឹក្សាកម្ចី", value: "false"},
      ],
  ...
  methods: {
    ...
    exportToExcel() {
      ...
      GlobalFn.exportExcelFile(workbook, "Survey " + moment().format("YYYYMMDD") + ".xlsx");
    },
    FormatNumber(val) {
    ...
    handleRun() {
      ...
      if (this.$refs.formReport.validate()) {
        ...
        Meteor.call('sb_fetchSurveyReport', this.params, Constants.secret, vm.$i18n.locale, (err, result) => {
          if (result) {
