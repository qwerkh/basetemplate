          ...
          style="align-items: center; margin-top: 0px !important;margin-bottom: 5px !important;border-top:1px solid black !important;margin-left: 25% !important;margin-right: 25% !important;">
              ...
              <center v-if="companyDoc.isHasBanner">
                ...
                <v-col cols="12" md="12" sm="12" style="text-align: center !important;padding: 0px !important;">
                        <span style="font-family: 'Khmer OS Muol'; font-size: 15px;">{{ $t('parTitle') }}</span><br>
                </v-col>
                ...
                <thead style="margin-top: 5px">
                 ...
                 <tr style="border: 0px !important;font-family:'Khmer OS Muol'">
                        <th colspan="19" style="border: 0px !important;text-align: left !important;">
                        <span
                            style="font-family: tacteing"></span> {{ $t('averagePar') }}<br>
                        </th>
                    </tr>
                    <tr>
                        <th rowspan="2" style="vertical-align: middle !important;">{{ $t('no') }}</th>
                        <th rowspan="2" style="vertical-align: middle !important;">{{ $t('staffName') }}</th>
                        <th rowspan="2" style="vertical-align: middle !important;">{{ $t('currency') }}</th>
                        <th colspan="2" style="vertical-align: middle !important;">{{ $t('loanAmount') }}</th>
                        <th colspan="3" style="vertical-align: middle !important;">{{ $t('totalArrear7to360') }}</th>
                        <th colspan="3" style="vertical-align: middle !important;">{{ $t('from1to6') }}</th>
                        <th colspan="3" style="vertical-align: middle !important;">{{ $t('from7to15') }}</th>
                        <th colspan="3" style="vertical-align: middle !important;">{{ $t('from16to30') }}</th>
                        <th colspan="3" style="vertical-align: middle !important;">{{ $t('arrears') }}</th>

                    </tr>
                    <tr>
                        <th style="vertical-align: middle !important;">{{ $t('client') }}</th>
                        <th style="vertical-align: middle !important;">{{ $t('loanOutStanding') }}</th>
                        <th style="vertical-align: middle !important;">{{ $t('client') }}</th>
                        <th style="vertical-align: middle !important;">{{ $t('loanOutStanding') }}</th>
                        <th style="vertical-align: middle !important;">{{ $t('par') }}</th>
                        <th style="vertical-align: middle !important;">{{ $t('client') }}</th>
                        <th style="vertical-align: middle !important;">{{ $t('arrearsPrin') }}</th>
                        <th style="vertical-align: middle !important;">{{ $t('par') }}</th>
                        <th style="vertical-align: middle !important;">{{ $t('client') }}</th>
                        <th style="vertical-align: middle !important;">{{ $t('arrearsPrin') }}</th>
                        <th style="vertical-align: middle !important;">{{ $t('par') }}</th>
                        ...
                        <th style="vertical-align: middle !important;">{{ $t('arrearsPrin') }}</th>
                        <th style="vertical-align: middle !important;">{{ $t('par') }}</th>
                         <th style="vertical-align: middle !important;">{{ $t('principle') }}</th>
                        <th style="vertical-align: middle !important;">{{ $t('interest') }}</th>
                        <th style="vertical-align: middle !important;">{{ $t('operationFee') }}</th>
                ...
                <tbody class="tableCollapse" style="margin-bottom: 5px;" v-html="dataHtml1">
                </tbody>
               ...
               <tr style="border: 0px !important;font-family:'Khmer OS Muol'">
                        <th colspan="19" style="border: 0px !important;text-align: left !important;">
                        <span style="font-family: tacteing"></span> {{ $t('highPar') }}<br>
                        </th>
                    </tr>
                    ...
                    <tr>
                        ...
                        <th rowspan="2" style="vertical-align: middle !important;">{{ $t('currency') }}</th>
                        <th colspan="2" style="vertical-align: middle !important;">{{ $t('loanAmount') }}</th>
                        <th colspan="3" style="vertical-align: middle !important;">{{ $t('totalArrear1to360') }}</th>
                        <th colspan="3" style="vertical-align: middle !important;">{{ $t('from31to90') }}</th>
                        <th colspan="3" style="vertical-align: middle !important;">{{ $t('from91to360') }}</th>
                        <th colspan="3" style="vertical-align: middle !important;">{{ $t('from361Up') }}</th>
                        <th colspan="3" style="vertical-align: middle !important;">{{ $t('arrears') }}</th>
                ...
                <tbody class="tableCollapse" style="margin-bottom: 5px;" v-html="dataHtml2">
                </tbody>
...
export default {
  ...
  created() {
    ...
    this.isNotPenalty = loanConfig.isNotPenalty;
    this.isLoanAmount = loanConfig.isLoanAmountInCollect;
    this.isPayOffInCollect = loanConfig.isPayOffInCollect || false;
  ...
  methods: {
    ...
    exportToExcel() {
      ...
      workbook.SheetNames.push("Par");
      workbook.Sheets["Par"] = worksheet;

      GlobalFn.exportExcelFile(workbook, "Par " + moment().format("YYYYMMDD") + ".xlsx");
    },
    FormatNumber(val) {
    ...
    handleRun() {
      ...
      if (this.$refs.formReport.validate()) {
        this.dataHtml = "";
        Meteor.call('sb_fetchParReport', this.params, Constants.secret, vm.$i18n.locale, (err, result) => {
          if (result) {
            this.dataHtml1 = result.dataHtml1;
            this.dataHtml2 = result.dataHtml2;
          }
          this.loading = false;
        });
      } else {
